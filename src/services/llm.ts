...
export class LLM {
    ...
    async load(model: any, options: any) {
        ...
        console.log(`loading... ${model.name},  ${provider}`);
    ...
    //
    update_kv_cache(feed: any, outputs: any) {
    ...
    //
    async generate(tokens: any, callback: Function, options: any) {
